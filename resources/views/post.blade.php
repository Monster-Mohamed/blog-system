      ...
      <div class="col-md-8">
        <div class="row row-pb-lg">
          <div class="col-md-12 animate-box">
            <div class="classes class-single">
              <div class="classes-img" style="background-image: url(blog_temp/images/classes-1.jpg);">
              </div>
        ...
        <div class="row row-pb-lg animate-box">
          <div class="col-md-12">
            ...
            <div class="review">
              <div class="user-img" style="background-image: url(blog_temp/images/person1.jpg)"></div>
              <div class="desc">
                <h4>
            ...
            <div class="review">
              <div class="user-img" style="background-image: url(blog_temp/images/person2.jpg)"></div>
              <div class="desc">
                <h4>
                  <span class="text-left">Jacob Webb</span>
                  <span class="text-right">24 March 2018</span>
            ...
            <div class="review">
              <div class="user-img" style="background-image: url(blog_temp/images/person3.jpg)"></div>
              <div class="desc">
                <h4>
                  <span class="text-left">Jacob Webb</span>
                  <span class="text-right">24 March 2018</span>
      ...
      <div class="col-md-4 animate-box">
        <div class="sidebar">
          ...
          <div class="side">
            ...
            <div class="f-blog">
              <a href="blog.html" class="blog-img" style="background-image: url(blog_temp/images/blog-1.jpg);">
              </a>
              <div class="desc">
            ...
            <div class="f-blog">
              <a href="blog.html" class="blog-img" style="background-image: url(blog_temp/images/blog-2.jpg);">
              </a>
              <div class="desc">
                <p class="admin"><span>18 April 2018</span></p>
                <h2><a href="blog.html">Creating Mobile Apps</a></h2>
            ...
            <div class="f-blog">
              <a href="blog.html" class="blog-img" style="background-image: url(blog_temp/images/blog-3.jpg);">
              </a>
              <div class="desc">
                <p class="admin"><span>18 April 2018</span></p>
                <h2><a href="blog.html">Creating Mobile Apps</a></h2>
